    ...
    >
      <div className="mx-auto grid w-full max-w-6xl gap-12 md:grid-cols-2 md:gap-16">
        <div>
          ...
          <Reveal
            delay={0.2}
            className="mt-10 inline-flex flex-col gap-1 rounded-lg border border-white/10 bg-white/5 px-6 py-5 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-accent/50 hover:shadow-[0_0_28px_rgba(255,255,255,0.2)]"
          >
        ...
        <div>
          <Reveal className="relative mx-auto hidden aspect-video w-full max-w-sm md:block">
            <div
              className="absolute -inset-4 rounded-[1.75rem] bg-[radial-gradient(circle_at_30%_30%,rgba(255,255,255,0.22),transparent_70%)] blur-2xl"
              aria-hidden="true"
            />
            <div className="relative h-full w-full overflow-hidden rounded-[1.75rem] border border-white/10 bg-white/5 shadow-[0_18px_50px_-20px_rgba(255,255,255,0.4)] backdrop-blur-md">
              <div
                className="absolute inset-0 bg-[repeating-linear-gradient(90deg,rgba(255,255,255,0.07)_0px,rgba(255,255,255,0.07)_1px,transparent_1px,transparent_18px)]"
                aria-hidden="true"
              />
              <div
